...
@Library('github.com/campbelldgunn/jenkins-pipeline@v0.6')
...
podTemplate(label: 'jenkins-pipeline', nodeSelector: 'os=linux', containers: [
    ...
    containerTemplate(name: 'helm', image: 'gunnertime/k8s-helm:v2.6.1', command: 'cat', ttyEnabled: true),
    containerTemplate(name: 'kubectl', image: 'gunnertime/k8s-kubectl:v1.8.0', command: 'cat', ttyEnabled: true)
],
volumes:[
