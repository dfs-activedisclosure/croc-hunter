...
podTemplate(label: 'jenkins-pipeline', nodeSelector: 'os=linux', containers: [
    ...
    containerTemplate(name: 'docker', image: 'docker:1.12.6', command: '/bin/cat', ttyEnabled: true),
    containerTemplate(name: 'golang', image: 'golang:1.8.3', command: '/bin/cat', ttyEnabled: true),
